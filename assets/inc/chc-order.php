    <div class="order-area">
        <img class="order-img" src="/sp/assets/img/chc-cover.png">
        <div class="order-form">
            <h2 class="order-title">Receive Your Crystal Healing Chronicles For Just $17.00</h2>
            ...
            <a class="cta-button" href="http://individualogist.samcart.com/products/chc">Click Here To Order Now</a>
