    <div class="eote-order-area">
        <img class="order-img" src="/sp/assets/img/eote-cover.png">
        <div class="order-form">
            <h2 class="order-title">Receive Your Eclipse Of The Ego For Just $67.00</h2>
            ...
            <a class="cta-button" href="http://individualogist.samcart.com/products/eote">Click Here To Order Now</a>
