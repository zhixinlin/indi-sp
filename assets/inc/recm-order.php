    <div class="order-area">
        <img class="order-img" src="/sp/assets/img/recm-cover.png">
        <div class="order-form">
            <h2 class="order-title">Receive Your Reiki Energy Channelling Mastery For Just $27.00</h2>
            ...
            <a class="cta-button" href="http://individualogist.samcart.com/products/recm">Click Here To Order Now</a>
