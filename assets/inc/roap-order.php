    <div class="order-area">
        <img class="order-img" src="/sp/assets/img/roap-cover.png">
        <div class="order-form">
            <h2 class="order-title">Receive Your Revolution Of Astral Projection For Just $17.00</h2>
            ...
            <a class="cta-button" href="http://individualogist.samcart.com/products/roap">Click Here To Order Now</a>
