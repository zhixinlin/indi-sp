...
<div class="eote-container">
    ...
    <div class="eote-reading">
        ...
        <p>You already know how powerful Individuation is. And I know how serious you are about <span class="goldenrod">embarking on this journey.</span></p>
        ...
        <p>But I sense that there is something that stands in your way…</p>
        ...
        <p>Don’t get me wrong, I’m not saying that you’re deliberately stopping yourself from achieving greatness!</p>

        <p>You are, however, subconsciously holding yourself back.</p>
        ...
        <p>…Because what I’m about to say next just might be the most important thing that you’ll ever have to hear.</p>

        <p>The blockage that your facing is a difficult problem to resolve, but it’s not impossible.</p>

        <p>In fact, with the right knowledge, the right tools, and the right mindset, overcoming this boulder will be so easy that you could have done it as a child!</p>
        ...
        <div class="point-glow">
            ...
            <p>You are the master of your own soul.</p>
            <p>But it’s almost impossible to steer yourself in the right direction...</p>
            <p>…Not when your Ego’s fighting you for the driver’s seat.</p>
        </div>
        ...
        <ul class="eote-bullet">
            ...
            <li>If manifestation doesn’t seem to be working for you…</li>
            <li>If your numerology predictions don’t seem to be taking place…</li>
            <li>If you’re feeling as if the cosmos isn’t blessing you like the gurus said it would…</li>
        </ul>
        ...
        <p>The door is ajar… it’s unlocked and it’s open.</p>

        <p>And the <span class="goldenrod">life that you’ve always dreamed of</span> lies beyond that door…</p>

        <p>…Would you open it?</p>

        <p>Of course you would!</p>

        <p>And you know what? That’s exactly the situation that you are in right now.</p>
        ...
        <div class="point-glow">
            ...
            <p>features 8 complete modules of high quality content</p>
            <p>to help you transcend your ego…</p>
            <p>…to finally reach your SELF.</p>
        </div>

        <img class="img-intext" src="../assets/img/eote-cover.png">

        <p>The Supreme Mastery Code: Eclipse of the Ego is a mastery audio course that will teach you exactly what you need to do to <span class="goldenrod">identify your Ego</span>, and remove it from the equation.</p>
        ...
        <p>They convince themselves that they’re able to do this on their own…</p>

        <p>They convince themselves that whatever they have right now is “good enough”…</p>

        <p>Some even convince themselves that they don’t even have this problem to begin with!</p>
        ...
        <img class="img-intext" src="../assets/img/eote-6.jpg">

        <p>Discovering your archetype is the first leg of the journey.</p>

        <p>Diminishing your Shadow is the second leg of the journey.</p>

        <p>What’s the final leg, you ask?</p>

        <p>It’s transcending your Ego to reach your true Self…</p>

        <p>…To finally become one with your soul…</p>

        <p>To finally release yourself from who you think you are, and transform into who you were meant to be.</p>

        <h2 class="eote-sub-header">Now, this is what the Eclipse of the Ego is going to deliver to you instantly.</h2>

        <div class="point-glow">
            <p>A proven, progressive method to create the life you envisioned</p>
            <p>Identify, encounter, and crush your Ego</p>
        ...
        <p>Because it will be transferred over to someone else who’s willing to embark on this journey.</p>
        ...
        <p>This is your chance to embark on an <span class="goldenrod">epic journey.</span> A journey that’s going to help you achieve anything and everything that you set your sights on.</p>

        <div class="point-glow">
            <p>You want to have a better body or better health? Done.</p>
            <p>You want to be overwhelmed with success? Say no more.</p>
            <p>You want to attract the right people into your life? Done, done, and done.</p>
        </div>
        ...
        <p>You cannot put a price on such an amazing opportunity. Because it truly is priceless.</p>
        ...
        <p>But if you are really serious about making an astronomical change in your life…</p>

        <p>If you are really serious about transcending your Ego…</p>

        <p>If you are really serious about reaching your Self and unlocking all the riches of the world…</p>

        <p>Then you have to <span class="goldenrod">say “Yes!” right now.</span></p>

        <p>Here’s what’s going to happen after you say “Yes!” to this amazing, <span class="goldenrod">life-changing opportunity.</span></p>

        <h2 class="eote-sub-header">You will be given the Supreme Mastery Code: Eclipse of the Ego for only $67.</h2>

        <p>That’s 8 complete modules in audio format, the same 8 modules in an eBook format, and an entire beautifully-designed online workbook to solidify your progress…</p>

        <p>…All for the small price of $67.</p>

        <p>I know what you’re thinking… $67 seems a little pricey.</p>

        <p>But that’s your Ego that’s talking, and not your true Self. You know deep down in your soul that this package contains an <span class="goldenrod">enormous amount of value,</span> and it’s what you truly need.</p>
        ...
        <p>But that’s not all, friend. Each module in the Eclipse of the Ego has been narrated over scientifically tested and proven <span class="goldenrod">theta subliminal tracks…</span></p>

        <p>…Why?</p>

        <p>To enhance your learning, of course! We want you to experience the results of this program as quickly as possible – almost instantly even!</p>

        <p>That’s how much <span class="goldenrod">thought, effort, and work</span> has gone into this revolutionary program.</p>

        <p>Once again, here’s a breakdown of all of the contents in the Supreme Mastery Code: Eclipse of the Ego:</p>
        ...
        <p>Now, here’s what you need to do next.</p>
...
<?php
$path = $_SERVER['DOCUMENT_ROOT'];
$path .= ('/sp/assets/inc/eote-order.php');
include($path);
?>
