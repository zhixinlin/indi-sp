...
<div class="recm-container">
    ...
    <div class="recm-reading">
        ...
        <p>…You understand it to be an <span class="purple">indicator of POTENTIAL.</span></p>

        <p>The more knowledge one has, the greater their potential – that is one of the laws of nature and the universe.</p>
        ...
        <h2 class="recm-sub-header">Here's How It Works...</h2>
    
        <p>We experience consciousness because of our universal life force… This force is distributed throughout the rest of our body using various channels…</p>

        <p>It flows through our bodies like blood, but not in a tangible or physical manner.</p>

        <p>Think of Chakras, Meridians, and Nadis.</p>
        ...
        <p>And yes, that’s what ultimately “heals” you…</p>

        <p>Ever wondered why they say that laughter’s the best medicine? <span class="purple">Reiki is the reason.</span></p>

        <p>But healing’s merely scraping the surface – that’s not all that Reiki does.</p>
        
        <div class="bullet-purple">
            <p>It also offers stress reduction and relaxation by triggering the body’s natural healing abilities (immune system)</p>
            <p>It improves your sleeping patterns and overall sleep quality, giving you an energetic and awakened state of mind</p>
            <p>It moulds your mind, body, and soul to experience inner peace and harmony, making it a valuable tool for spiritual growth and self-discovery</p>
            <p>It balances your mind and your emotions, forming the core of what we know as being in a state of tranquility</p>
            <p>It enhances your learning, memory and mental clarity, allowing you to alleviate your mental and emotional being while relieving yourself of negativities such as fear and anger.</p>
            <p>It enhances your capability to love, giving you the courage and transparency to open yourself up to others and improve the relationships that you share with people</p>
            <p>It has the capacity to physically restore your body and provide you with pain relief, especially if you experience migraines, arthritis, or other difficult conditions</p>
        </div>
        ...
        <p>In fact, you’ll be able to pick all of this up in no time!</p>

        <p>Because we’ve prepared a complete kit for you that will equip you with <span class="purple">everything you need to know about Reiki Energy Channelling.</span></p>
        
        <img class="img-intext" src="http://individualogist.com/wp-content/uploads/2018/01/recm-product.png">
        ...
        <p>And although such <span class="purple">powerful information</span> should not be distributed freely, I want you to have this at a low price point…</p>

        <p>So, of course, It’s not going to cost you hundreds of dollars…</p>

        <p>…Or even $50.</p>

        <p>For <span class="purple">just $27</span>, you’ll be able to begin mastering Reiki Energy Channelling, and experience all of the wondrous benefits that I mentioned before…</p>
        
        <p>...Reduced stress and anxiety</p>
        
        <p>...Improved sleep quality</p>
        
        <p>...Higherlevels of vibrations</p>
        
        <p>...A deeper connection with yourself and others</p>
        
        <p>...The title of an Energy Healer</p>
        
        <p>....Spiritual attunement</p>
        
        <p>There is no better time to start than right now…</p>

        <p>The doors have been opened for you, and it’s time to experience what Reiki can <span class="purple">truly achieve for you and your loved ones.</span></p>

        <p>This is final step…</p>

        <p>I have a strong feeling that you were destined to see this – to take this opportunity upon yourself.</p>
        ...
        <p>Now, simply click on the button below to <span class="purple">begin your Reiki Energy Mastery journey!</span></p>
    </div>

<?php
$path = $_SERVER['DOCUMENT_ROOT'];
$path .= ('/sp/assets/inc/recm-order.php');
include_once($path);
?>
