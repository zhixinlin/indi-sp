...
<div class="sac-container">
    ...
    <?php echo $_GET['archetype']; if(empty($_GET)) { echo 'Caregiver'; 
        ...
        <p>“How on earth did they know this about me?!”</p>
        ...
        <img class="img-intext" src="../assets/img/sac1.png">
        ...
        <p>…A journey that will lead to a <span class="purple">lifetime of rewards.</span></p>

        <p>A journey that will elevate you to the realm of <span class="purple">infinite abundance.</span></p>
        ...
        <h2 class="sac-sub-header">You Were Introduced To Your Archetype For <span class="goldenrod">A Reason...</span></h2>
        ...
        <p>…A lack of <span class="purple">motion.</span></p>

        <p>Perhaps you’ve achieved everything you’ve wanted in life, and you’re not sure where to go or what to do next.</p>

        <p>Perhaps you’re uncertain about taking a <span class="purple">risk</span> with your relationships or your work.</p>
        ...
        <p>It is a period for you to <span class="purple">step out of your comfort zone…</span> To become a better version of who you are, and to grow closer to who you were meant to be.</p>

        <p>…And it all begins with your archetype – The <span class="archetype">Archetype</span>.</p>

        <p>But as the saying goes…</p>
        
        <h2 class="sac-sub-header">“Without <span class="goldenrod">knowledge,</span> action is useless. And knowledge without <span class="goldenrod">action,</span> is futile”</h2>
        ...
        <p>And I have a gift that will lead you towards your destiny…</p>

        <p>…A gift of opportunity, guidance, and revelations.</p>
        ...
        <img class="img-intext" src="../assets/img/sac3.png">
        
        <p>One of these materials is the Archetypal Affirmations Guide – a series of <span class="purple">21 potent affirmations</span> that have been customized to your archetype.</p>
        ...
        <p>Each affirmation in this guide has been masterfully crafted by actualized individuals belonging to your Archetypal family.</p>
        ...
        <h2 class="sac-sub-header">Your Archetypal Love Compatibility Guide</h2>
    
        <img class="img-intext" src="../assets/img/sac4.png">    
        ...
        <p>This is a highly detailed guide that gives you all the information you need to determine how you <span class="purple">interact</span> with people of other archetypes, and whether they’re compatible with you at a fundamental level.</p>

        <p>If you’ve already found <span class="purple">“the one”</span> for you, this guide will give you the exact confirmation you need to know that you’re with the right person; your perfect partner.</p>

        <p>This is a guide that’s unlike any other, and I have no doubt that you will gain <span class="purple">immense value</span> from its insights.</p>

        <p>You’ll finally be able to instantly and accurately recognize potential partners, and sift out the ones whose thoughts, desires, and actions do not resonate with your archetype.</p>
        ...
        <ul class="bullet-purple">
            <li>Exactly what you need to do to become a Master of your archetype – The Caregiver</li>
        ...
        <p>There is no reason for you to wait any longer.</p>
...
<?php
$path = $_SERVER['DOCUMENT_ROOT'];
$path .= ('/sp/assets/inc/sac-order.php');
include($path);
?>
    ...
    <div class="sac-reading">
        ...
        <p>In just minutes, you can witness <span class="purple">life-changing phases</span> with each passing day with your Archetypal Affirmations Guide.</p>

        <p>In just seconds, you can possess the <span class="purple">confidence</span> to understand your relationships at a profound level.</p>
        ...
        <p>And no, it isn’t even going for the small price of $37. And believe me, there are plenty of readings that are going for that price… Trouble is, those products are lacklustre at best.</p>
...
?>
    ...
    <div class="sac-reading">
        ...
        <p>And that’s why it’s extremely important to us that you stick closely to the <span class="purple">affirmations guide</span> for 21 days, and go through the Archetypal Love Compatibility Guide in excruciating detail.</p>

        <p>That’s all we ask – for you to <span class="purple">take this seriously.</span></p>

        <p>Because when you do, I promise that you will experience the wondrous effects of your archetype and individuation.</p>
        ...
        <p>But I urge you to take this entirely <span class="purple">risk-free chance</span> to truly transform yourself…</p>

        <p>To actually <span class="purple">become the person</span> that you’ve always wanted to be, and to finally live the life that you’ve always wanted.</p>
